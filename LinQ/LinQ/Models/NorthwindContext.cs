...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<ProdcutCategory> ProdcutCategories { get; set; }

    public virtual DbSet<ProdcutSeafoodCategory> ProdcutSeafoodCategories { get; set; }
    ...
    public virtual DbSet<Satisraporlari> Satisraporlaris { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=TITAN06\\SQLEXPRESS;Database=Northwind;Trusted_Connection=True;TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__account__F267251E94563438");
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("deleteemployee"));
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.ToTable("Order Details", tb => tb.HasTrigger("sellproduct"));
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PhoneNum__3214EC071BF2A4C8");
        ...
        modelBuilder.Entity<ProdcutCategory>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ProdcutCategory");

            entity.Property(e => e.CategoryName).HasMaxLength(15);
            entity.Property(e => e.ProductName).HasMaxLength(40);
        });

        modelBuilder.Entity<ProdcutSeafoodCategory>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ProdcutSeafoodCategory");
        ...
        modelBuilder.Entity<Satisraporlari>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("satisraporlari");
